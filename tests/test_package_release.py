...
source_libraries 跨平台使用 脚本模式 v0.7.1 package-lint --strict
"""
...
def test_release_validation_and_hash_refresh_are_application_scoped() -> None:
    with tempfile.TemporaryDirectory() as raw:
        ...
        assert package_lint(root, release_version="v0.7.1")["passed"] is True
        (root / "SKILL.md").write_text("changed", encoding="utf-8")
        result = package_lint(root, release_version="v0.7.1")
