...
CONTRACTS = (
    ...
    _contract("source.article", "source", requires=("core.transactional-pipeline",), mode="instruction", entrypoint="references/reading-and-refinement.md", inputs=("article-source",), outputs=("source-candidate",), gates=("source-readable",)),
    ...
    _contract("research.role-enablement", "research", requires=("research.topic-synthesis",), mode="instruction", entrypoint="references/role-enablement.md", inputs=("topic-page", "role-profile"), outputs=("role-enablement-model",), gates=("role-boundary-clear", "evidence-threshold")),
    ...
    _contract("asset.product-knowledge-card", "asset", requires=("research.role-enablement",), mode="instruction", entrypoint="references/role-enablement.md", inputs=("role-enablement-model",), outputs=("product-knowledge-card",), gates=("product-version-attributed", "role-boundary-clear")),
    ...
    _contract("output.operations-sop", "output", requires=("research.role-enablement",), mode="instruction", entrypoint="references/role-enablement.md", inputs=("role-enablement-model",), outputs=("operations-sop",), gates=("steps-testable", "risk-boundary-clear")),
    _contract("output.training-module", "output", requires=("research.role-enablement",), mode="instruction", entrypoint="references/role-enablement.md", inputs=("role-enablement-model",), outputs=("training-module",), gates=("learning-objective-testable", "evidence-threshold")),
