...
def build_parser(version: str) -> argparse.ArgumentParser:
    ...
    item = sub.add_parser("extract"); item.add_argument("--limit", type=int); item.add_argument("--max-attempts", type=int); item.add_argument("--source-type"); item.add_argument("--job-id")
    item = sub.add_parser("claim"); item.add_argument("--worker", required=True); item.add_argument("--limit", type=int); item.add_argument("--lease-minutes", type=int); item.add_argument("--source-type"); item.add_argument("--job-id")
